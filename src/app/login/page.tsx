...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col items-center justify-center px-4 py-20">
      ...
      <a
        href="/auth/login"
        className="mt-8 flex w-full items-center justify-center gap-2 rounded-lg bg-foreground px-4 py-3 font-medium text-background transition-opacity hover:opacity-90"
      >
